...
export const TERMS_LAST_UPDATED = "6 de septiembre de 2026"
export const TERMS_VERSION_LABEL = "v1-2026"

/**
 * Contenido íntegro de los Términos y Condiciones.
 * Lo comparten la página pública /terminos-y-condiciones y la puerta de
 * aceptación /terminos del portal del cliente — un solo lugar que editar.
 */
    ...
    <>
      ...
      <div className="px-8 py-6" style={{ background: "#004238" }}>
        ...
        <p className="text-xs mt-2" style={{ color: "rgba(255,255,255,0.75)" }}>
          Versión {TERMS_VERSION_LABEL} · Última actualización: {TERMS_LAST_UPDATED}
        </p>
      </div>
      ...
      <div className="px-8 py-7 space-y-7 text-slate-700 text-sm leading-relaxed">
        ...
        <Section title="Propiedad Intelectual">
          ...
          <br /><br />
          Las marcas de terceros que llegasen a mostrarse en la Plataforma (incluyendo Visa y
          American Express) son propiedad de sus respectivos titulares y se utilizan únicamente
          con fines identificativos de los medios de pago aceptados.
        </Section>
...
function PdfLink({ href, label }: { href: string; label: string }) {
  return (
    ...
    >
      <svg className="h-4 w-4 text-slate-500 shrink-0" viewBox="0 0 24 24" fill="none"
